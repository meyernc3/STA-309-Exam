---
title: "Midterm Exam 3 problem 2"
author: "Nolan Meyer"
date: "2025-04-23"
...
get_song_sentiment <- function(path) {
  ...
  sentiment_counts %>%
    mutate(
      song = tolower(tools::file_path_sans_ext(basename(path))),
...
all_sentiment <- bind_rows(album1_sentiment, album2_sentiment, album3_sentiment)
